    ...
    internal class Clsmenu
    {
        ...
        public static void mostrarMenu()
        {
            ...
            while (!salir)
            {
                ...
                switch (opcion)
                {
                    case 1: clsTransacciones.OpcionInicializarVectores();
                            
                        break; 
                    case 2: clsTransacciones.Ingresar();

                        break; 
                    case 3: clsTransacciones.Consultar();

                        break;
                    case 4: clsTransacciones.Modificar();
                        break;
                    case 5: clsTransacciones.Reporte();
                        break;
                    case 6:
                        salir = true;
                        break;
